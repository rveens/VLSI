...
The minimum sample time estimation is extracted from the synthesis report under \textit{Timing Report}.\\

\textbf{Minimum period: 8.421ns (Maximum Frequency: 118.750MHz)}\\
